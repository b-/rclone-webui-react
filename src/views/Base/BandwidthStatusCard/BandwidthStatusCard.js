      ...
      <Card>
        <CardHeader>
          ...
          <button
            ...
            onClick={this.toggleShowChangeBandwidth}
          >
            Modify
          </button>
        </CardHeader>
        <CardBody>
          <p>
            ...
            <span className="card-text">
              {bandwidth.rate !== "off" ? bandwidth.rate : "Unlimited"}
            </span>
          </p>
          <Form
            onSubmit={this.setBandwidth}
            className={showChangeBandwidth ? "" : "d-none"}
          >
            <FormGroup row>
...
export default connect(mapStateToProps, { getBandwidth, setBandwidth })(
  BandwidthStatusCard
);

        ...
        elements.push(
          <Col sm={12} lg={4} md={6} key={head}>
            <Card>
              ...
              <CardBody>{this.getOptionViewCards(head, value)}</CardBody>
            </Card>
          </Col>
        );
      }

  ...
  it("should return new state for GET_CONFIG_DUMP SUCCESS", function () {
    const dump = {
      eventsfunk: {
        ...
        team_drive: "",
        token:
          '{"access_token":"ya29.GlwpBwoWlgdY4iklkvTyGKcAj-riCDNbXFQ2yxQeofU9Jqqv8ynvDKzugTJYVOJMhEjkisDveOFmQwpYuh4Jdp0C8NHrG3FRmYzxnPubVtX3dyIjEglit-1KCQbJ6A","token_type":"Bearer","refresh_token":"1/kwlvEghV-Kutx0LPoazLviSzI3wY8RCBUVnM53MpjtI","expiry":"2019-06-17T00:20:56.014222131+05:30"}',
        trashed_only: "false",
        type: "drive",
        upload_cutoff: "8M",
